# 🎓 AI в образовании: помогает или вредит?

**Анализ влияния GenAI-инструментов на успеваемость, выгорание и навыки студентов**
...
5. [Влияние политики вуза](#5-влияние-политики-вуза)
...
### 3.3 Визуализация: распределение GPA_delta
...
### 4.1 Как объём использования ИИ влияет на GPA и выгорание
...
```python
# График: двойная ось — GPA delta и Burnout
...
### 8.1 T-test: Strict_Ban vs Actively_Encouraged
...
### 8.2 T-test: платная подписка vs удержание навыков
...
### 8.5 ANOVA: сценарий использования ИИ → GPA_delta
...
**F = 287, p < 0.001** — сценарий использования ИИ значимо влияет на прирост GPA. Не все способы использования ИИ одинаково полезны.
...
| 4 | **Запрет ИИ в вузе контрпродуктивен** | Strict_Ban → ниже GPA, выше выгорание (29.8% vs 23.8%) |
...
| Кому | Что делать |
|------|-----------|
| **Университеты** | Заменить Strict_Ban на Allowed_With_Citation — это снижает выгорание на 6 п.п. и улучшает GPA |
| **Университеты** | Ввести курс по промпт-инжинирингу — Advanced-пользователи учатся на 34% эффективнее |
...
| **Студенты** | Не просить ИИ напрямую давать ответы — это ухудшает и GPA, и навыки |
...
*Все цифры получены из реального датасета (50 000 строк). Проект для портфолио аналитика данных.*
